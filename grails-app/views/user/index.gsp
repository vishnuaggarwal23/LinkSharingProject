            ...
            <div class="panel panel-default panel-primary">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <span class="text-primary">Vishnu Aggarwal</span><br//>
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle" id="visibility" type="button" data-toggle="dropdown">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle" id="docTopic" type="button" data-toggle="dropdown">
                                        <span class="glyphicon glyphicon-user"></span>Public
                                        <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">.....</a></li>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle" id="docTopic" type="button" data-toggle="dropdown">
                                        <span class="glyphicon glyphicon-user"></span>Topic
                                        <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">.....</a></li>
                                        <li><a href="#">.....</a></li>
